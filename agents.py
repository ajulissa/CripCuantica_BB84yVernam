...
class Eve(Person):
    ...
    def XOR(self, i1, i2,value):
        """return value resulting of XOR operations from one bit at index i1 and one value i2 or from two bits at
        positions i1 and i2, depending on the input value of "value" """
        if value ==True:
