...
class System:
    ...
    def initializeTkinter(self):
        ...
        self.phase_label.insert(tk.END, 'Hola, bienvenido a esta\nsimulación del protocolo\nBB84.\nPor favor selecciona\nla tasa de espionaje\n(Ejm: 0 para sin\nespías, 0.3 para un\n30 % de espionaje):')
    ...
    def go_to_phase1(self, number):
        ...
        self.phase_label.insert(tk.END,"Fase 1: Transmisión de qubits")
        self.empty_space.grid_forget()
        self.btn_1 = tk.Button(master=self.menu_frame,
                               text="Simular un ciclo",
                               width=25,
                               height=5,
                               bg="grey",
                               fg="black",
    ...
    def go_to_phase2(self):
        ...
        self.phase_label.delete(1.0, tk.END)
        self.phase_label.insert(tk.END,'Fase 2: Key Sifting')
    ...
    def go_to_phase3(self):
        ...
        self.phase_label.delete(1.0, tk.END)
        self.phase_label.insert(tk.END,'Fase 3: Tasa de error')
        self.btn_1['text'] = 'Compute tasa de error'
    ...
    def go_to_phase4(self):
        ...
        self.empty_space3.grid(row=0, column=0)
        self.phase_label.delete(1.0, tk.END)
        self.phase_label.insert(tk.END,'Fase 4: Corrección de errores')
        self.btn_1['text'] = 'Corregir un error a la vez'
        self.empty_space2.grid_remove()
        self.btn_2['text'] = 'Corregir todos los errores'
        self.btn_2.grid(row=2,column=0)
    ...
    def go_to_phase5(self):
        ...
        self.phase_label.delete(1.0, tk.END)
        self.phase_label.insert(tk.END,'Fase 5: Privacy amplification (PA)')
    ...
    def error_rate(self):
        ...
        error_label = tk.Label(master=self.phase3_frame, text = 'La tasa de error es ' + str(error) + '. Quieres abortar o continuar con el postproceso?' )
        ...
        button_continue = tk.Button(master=self.button_frame, text = 'Continuar con el postproceso', command = self.continue_postprocessing)
    ...
    def finish_routine(self):
        ...
        if sharedKey:
            if private:
                displayText = 'Felicitaciones. Has obtenido una llave privada compartida. Puedes intentar otra vez o salir.'
            else:
                displayText = 'Desafortunadamente, Eve conoce algunas partes de tu llave privada compartida. You might want to try again by clicking on restart.'
        else:
            displayText = 'Desafortunadamente, you have not obtained the same private key. You might want to try again by clicking on restart.'
